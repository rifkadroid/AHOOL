...
if (count($argv) < 2) {
	...
	echo "be specified as your base ahool working directory.\n";
	echo "\n";
	echo "Examples:\n";
	echo "#generate-privdefs /\n";
	echo "#generate-privdefs /home/ahool/src/\n";
	echo "\n";
	exit -1;
}
...
$pdata .= " * Generated by ahool/tools/scripts/generate-privdefs.php\n";
$pdata .= " *\n";
$pdata .= " * ***************************************************\n";
