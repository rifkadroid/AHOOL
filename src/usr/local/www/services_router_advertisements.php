...
$ramode_help = gettext('Select the Operating Mode for the Router Advertisement (RA) Daemon.') .
	...
	'</dl>' .
	gettext('It is not required to activate DHCPv6 server on KONTROL-UTM when set to "Managed", "Assisted" or "Stateless DHCP", it can be another host on the network.') .
	'</div>';
