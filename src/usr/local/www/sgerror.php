...
$page_info = <<<EOD
# ----------------------------------------------------------------------------------------------------------------------
# KONTROL-UTM (C) is Copyright Konntrol (C) Tecnologia, EPP -  SquidGuard error page generator
...
$str[] = '<li id="list3"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> Se você acredita, por alguma razão, que este bloqueio é indevido, entre em contato com o administrador <a href="mailto:administrator@corporation.corp?Subject=Website blocked by KONTROL-UTM">E-mail Administrador</a></font></li>';
